...
<div class="flex flex-col mt-5">
	...
	<div class="flex-col mt-4 justify-center items-center">
		<form class="flex flex-col items-center" action="/user/likes" method="get">
			<div class="relative">
				<input
		...
		<table class="dark-text-white">
			<tr>
				<a href="/user/likes?orderBy=acordao&keywords={searchKeywords ? searchKeywords : ''}"
					><th>Acórdão</th></a
				>
				<a href="/user/likes?orderBy=relator&keywords={searchKeywords ? searchKeywords : ''}"
					><th>Relator</th></a
				>
				<a href="/user/likes?orderBy=orgao&keywords={searchKeywords ? searchKeywords : ''}"
					><th>Órgão Julgador</th></a
				>
				<a href="/user/likes?orderBy=data&keywords={searchKeywords ? searchKeywords : ''}"
					><th>Data</th></a
				>
			</tr>
		...
		<div class="mt-3 dark:text-white">
			{#each Array(totalPages) as _, i}
				<a
					href="/user/likes?page={i + 1}&keywords={searchKeywords
						? searchKeywords
